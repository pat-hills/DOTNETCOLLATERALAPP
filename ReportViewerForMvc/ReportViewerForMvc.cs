...
namespace ReportViewerForMvc
{
    ...
    public static class ReportViewerForMvc
    {
        ...
        public static SubreportEventClass SubReportProcessor { get; set; }
        ...
        internal static HtmlString GetIframe(ReportViewer reportViewer, object htmlAttributes, SubreportEventClass subreportevent)
        {
            ...
            if (subreportevent != null)
                SubReportProcessor = subreportevent;
