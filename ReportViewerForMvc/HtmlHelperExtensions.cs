...
namespace ReportViewerForMvc
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static HtmlString ReportViewer(HtmlHelper helper, ReportViewer reportViewer)
        {
            return ReportViewerForMvc.GetIframe(reportViewer, null,null);
        }
        ...
        {
            return ReportViewerForMvc.GetIframe(reportViewer, htmlAttributes,null);
        }
        ...
        /// <param name="htmlAttributes">The object containing the HTML attributes of the iframe.</param>
        /// <returns>An HTML iframe with the specified attributes that sets its heigh and width based on the content of the report.</returns>
        public static HtmlString ReportViewer(this HtmlHelper helper, ReportViewer reportViewer, object htmlAttributes, SubreportEventClass subreportevent)
        {
            return ReportViewerForMvc.GetIframe(reportViewer, htmlAttributes, subreportevent);
        }
        ...
        public static HtmlString ReportViewer(this HtmlHelper helper, object reportViewer, object report)
        {
            ...
            return ReportViewerForMvc.GetIframe(reportViewerControl, null,null);
        }
        ...
        public static HtmlString ReportViewer(this HtmlHelper helper, object reportViewer, object report, object htmlAttributes)
        {
            ...
            return ReportViewerForMvc.GetIframe(reportViewerControl, htmlAttributes,null);
        }
