...
namespace ReportViewerForMvc
{
    ...
    public static class ReportViewerExtensions
    {
        ...
        public static void SetProperties(this ReportViewer reportViewer, ReportViewer properties)
        {
            ...
            if (ReportViewerForMvc.SubReportProcessor!=null)
            reportViewer.LocalReport.SubreportProcessing += new SubreportProcessingEventHandler(ReportViewerForMvc.SubReportProcessor .SubReportProcessingEventHandler);
        }
