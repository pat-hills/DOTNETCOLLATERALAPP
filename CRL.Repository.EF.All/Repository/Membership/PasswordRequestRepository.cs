...
namespace CRL.Repository.EF.All.Repository.Memberships
{
    ...
    public class PasswordResetRequestRepository : Repository<PasswordResetRequest, int>, IPasswordResetRequestRepository
    {
        public PasswordResetRequestRepository(IUnitOfWork uow)
            : base(uow)
        {
        }
