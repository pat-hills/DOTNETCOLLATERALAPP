...
namespace CRL.Infrastructure.Caching
{
    ...
    public class Cache
    {
        ...
        public void AddToMyCache(String CacheKeyName, Object CacheItem, CachePriority MyCacheItemPriority, List<String> FilePath=null)
        {
            // 
            ...
            policy.AbsoluteExpiration = DateTimeOffset.Now.AddSeconds(6000.00);            
